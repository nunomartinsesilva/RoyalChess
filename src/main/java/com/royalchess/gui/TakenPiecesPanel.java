    ...
    public void redo(final Table.MoveLog moveLog) {
        ...
        for(final Move move : moveLog.getMoves()) {
            if(move.isAttack()) {
                ...
                if(takenPiece.getPieceAlliance() == Alliance.WHITE) {
                    ...
                    throw new RuntimeException("no white or black piece attacked");
                }
            }
        }
        ...
        Collections.sort(whiteTakenPieces, new Comparator<Piece>() {
            ...
            public int compare(Piece o1, Piece o2) {
                return o1.getPieceValue() > o2.getPieceValue() ? o1.getPieceValue() : o2.getPieceValue();
            }
        });
        ...
        for (final Piece takenPiece : whiteTakenPieces) {
            try {
                final BufferedImage image = ImageIO.read(new File("../art/"+ takenPiece.getPieceAlliance().toString().substring(0,1) + "" +takenPiece.toString() +".png"));
